...
// ---------------------------------------------------------------
// Adresse Formspree déjà utilisée par le site pour le formulaire de
// contact et la page "bientôt" — on réutilise la même pour que toutes
// les demandes arrivent dans la même boîte mail.
...
async function sendBookingRecapEmail(session) {
  ...
  try {
    ...
    // On ne fait jamais échouer le webhook pour un email raté — la
    // réservation reste confirmée même si l'email n'est pas parti.
